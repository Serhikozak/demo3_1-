...
gcloud auth activate-service-account --key-file /tmp/ansible/.ssh/D3-6b9714034636.json
...
kubectl create secret docker-registry gcr-json-key --docker-server=gcr.io --docker-username=_json_key --docker-password="$(cat /tmp/ansible/.ssh/D3-6b9714034636.json)" --docker-email=arnio.if@gmail.com
kubectl patch serviceaccount default -p '{"imagePullSecrets": [{"name": "gcr-json-key"}]}'
kubectl create secret generic cloudsql-instance-credentials --from-file=credentials.json=/tmp/ansible/.ssh/D3-6b9714034636.json
